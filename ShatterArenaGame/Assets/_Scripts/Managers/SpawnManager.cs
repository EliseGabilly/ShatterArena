...
public class SpawnManager : Singleton<SpawnManager> {
    ...
    internal void SpawnWorld() {
        ...
        //dead zones
        GameObject deadZoneGO1 = Instantiate(ResourceSystem.Instance.DeadZone, new Vector3(Const.Instance.MinTerrain-5, 0, 0), Quaternion.identity) as GameObject;
        ...
        GameObject deadZoneGO2 = Instantiate(ResourceSystem.Instance.DeadZone, new Vector3(Const.Instance.MaxTerrain+5, 0, 0), Quaternion.identity) as GameObject;
        ...
        GameObject deadZoneGO3 = Instantiate(ResourceSystem.Instance.DeadZone, new Vector3(0, 0, Const.Instance.MinTerrain-5), Quaternion.identity) as GameObject;
        ...
        GameObject deadZoneGO4 = Instantiate(ResourceSystem.Instance.DeadZone, new Vector3(0, 0, Const.Instance.MaxTerrain+5), Quaternion.identity) as GameObject;
